...
(function () {
  ...
  function demarrer() {
    ...
    // Une seule fois par session : si l'apprenant revient sur l'outil dans
    // le meme onglet, le popup ne se rouvre pas. Il reapparait a la
    // prochaine connexion, l'onglet ayant ete ferme entre-temps.
    var CLE_SESSION = "habitant-vu-" + cle;
    try {
      if (sessionStorage.getItem(CLE_SESSION) === "1") return;
      sessionStorage.setItem(CLE_SESSION, "1");
    } catch (e) { /* stockage indisponible : on affiche quand meme */ }
